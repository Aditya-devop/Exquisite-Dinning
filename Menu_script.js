let headerLi = document.querySelectorAll(".navbar ul li");
headerLi.forEach((list) => {
    list.addEventListener("click", () => {
        headerLi.forEach((lst) => {
            lst.classList.remove("active_anchor");
        });
        list.classList.add("active_anchor");
    });
});
